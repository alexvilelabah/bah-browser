...
const MAIN_STRINGS: Record<'en' | 'pt' | 'es', Record<string, string>> = {
  en: {
    ...
    'mnu.zoomIn': 'Zoom in', 'mnu.zoomOut': 'Zoom out', 'mnu.zoomReset': 'Reset zoom',
  ...
  pt: {
    ...
    'mnu.zoomIn': 'Aumentar zoom', 'mnu.zoomOut': 'Diminuir zoom', 'mnu.zoomReset': 'Zoom normal',
  ...
  es: {
    ...
    'mnu.zoomIn': 'Acercar', 'mnu.zoomOut': 'Alejar', 'mnu.zoomReset': 'Restablecer zoom',
