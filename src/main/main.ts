...
const MAIN_STRINGS: Record<'en' | 'pt' | 'es', Record<string, string>> = {
  en: {
    ...
    'mnu.zoomIn': 'Zoom in', 'mnu.zoomOut': 'Zoom out', 'mnu.zoomReset': 'Reset zoom', 'mnu.history': 'History',
  ...
  pt: {
    ...
    'mnu.zoomIn': 'Aumentar zoom', 'mnu.zoomOut': 'Diminuir zoom', 'mnu.zoomReset': 'Zoom normal', 'mnu.history': 'Histórico',
  ...
  es: {
    ...
    'mnu.zoomIn': 'Acercar', 'mnu.zoomOut': 'Alejar', 'mnu.zoomReset': 'Restablecer zoom', 'mnu.history': 'Historial',
